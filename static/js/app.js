...
function setupItemsCalculator() {
    ...
    function updateItemsCalc() {
        ...
        if (hasPackingData) {
            ...
            document.getElementById("plusFivePallets").textContent =
                formatNumber(plusBreakdown.pallets);
            ...
            document.getElementById("minusFivePallets").textContent =
                formatNumber(minusBreakdown.pallets);
            document.getElementById("minusFiveBoxes").textContent =
                formatNumber(minusBreakdown.boxes);
        } else {
